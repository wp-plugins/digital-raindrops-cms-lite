...
$OptionsStyleContent = array (
	array("name" => "Contents Styling",
		"type" => "heading2"),
	...
	array(
		...
		"id" => 'cmsc-Widgets-background-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsContents-background-image',
		"type" => "select",
	...
	array(
		...
		"desc" => 'Optional enter a color for the content background e.g #FFFFFF',
		"id" => 'cmsc-WidgetsContents-background-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-Widgets-horizontal-image',
		"type" => "select",
		"options" => $SidebarImages,
		"std" => ""),
	...
	array(
		...
		"id" => 'cmsc-Widgets-vertical-image',
		"type" => "select",
		"options" => $SidebarImages,
		"std" => ""),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHeader-margin-bottom',
		"type" => "numtext",
		"std" => '0'),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHeader-background-image',
		"type" => "select",
		"options" => $SidebarImages,
		"std" => ""),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHeader-background-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-Widgets-HeaderIcon-image',
		"type" => "select",
		"options" => $SidebarImages,
		"std" => ""),
	...
	array(
		...
		"id" => 'cmsc-Widgets-HeaderIcon-margin',
		"type" => "numtext",
		"std" => "0"),
	...
	array(
		...
		"id" => 'cmsc-Widgets-HeaderIcon-padding',
		"type" => "numtext",
		"std" => "0"),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHeader-text-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHeader-font-family',
		"type" => "text",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHeader-font-size',
		"type" => "numtext",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHeader-font-weight',
		"type" => "checkbox",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsContent-text-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsContent-font-family',
		"type" => "text",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsContent-font-size',
		"type" => "numtext",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsLink-text-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsLink-font-family',
		"type" => "text",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsVisited-text-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" =>  'cmsc-WidgetsVisited-font-family',
		"type" => "text",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHover-text-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHover-font-family',
		"type" => "text",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-WidgetsList-text-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"id" => 'cmsc-Widgets-ListBullet-image',
		"type" => "select",
		"options" => $SidebarImages,
		"std" => ""),
	...
	array(
		...
		"id" => 'cmsc-WidgetsHover-background-color',
		"type" => "color",
		"std" => ''),
	...
	array(
		...
		"desc" => 'Optional Content font family i.e. Arial, Helvetica, Sans-Serif',
		"id" => 'cmsc-WidgetsList-font-family',
		"type" => "text",
		"std" => ''),
	...
	array(
		"name" => 'List Font Size',
		"desc" => 'Optional Content font size i.e. 14',
		"id" => 'cmsc-WidgetsList-font-size',
		"type" => "numtext",
		"std" => ''),
);
		
function cms_content_style_add_admin() {
	global $OptionsStyleContent;

    if ( $_GET['page'] == 'cmscontentstyle') {
   
        if ('save' == $_REQUEST['action'] ) {

                foreach ($OptionsStyleContent as $value) {
			...
			header("Location:admin.php?page=cmscontentstyle&saved=true");	
        } 
	}
}

// Create the admin form
function cms_content_style_admin() {
	global $OptionsStyleContent;
    if ( $_REQUEST['saved'] ) echo '<div id="message" class="updated fade"><p><strong>settings saved.</strong></p></div>';
?>
<div class="wrap">
	<h2>CMS-Lite content Pane Styling Management</h2>
	<?php
...
<?php foreach ($OptionsStyleContent as $value) {
...
?>
		...
		<textarea name="sbcodecode" style="width:100%;height:500px;border-color:red;"><?php echo get_content_styles(); ?></textarea>
	</form>
</div>
<?php
}
add_action('admin_menu', 'cms_content_style_add_admin'); 
